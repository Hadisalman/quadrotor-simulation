...
int main(int argc, char **argv) {
	...
	pos_sub = nh.subscribe( "/uav2/ground_truth_to_tf/pose", 1000, position_cb );
	...
	PoseActionClient poc(nh, "/uav2/action/pose"),poc2(nh2, "/uav2/action/pose");
	poc.waitForServer();
	// poc2.waitForServer();
	...
	LandingClient lnc(nh, "/uav2/action/landing");
	lnc.waitForServer();
